"""
Django settings for tsarkova_bot project.
...
ALLOWED_HOSTS = ["localhost", "elirm.ru", "dc.elirm.ru", "37b3-89-113-157-161.ngrok-free.app"]
...
ROOT_URLCONF = 'tsarkova_bot.urls'
...
WSGI_APPLICATION = 'tsarkova_bot.wsgi.application'
